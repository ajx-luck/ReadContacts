package com.contacts.read.readcontacts.utils;
...
import com.contacts.read.readcontacts.AddContactsService;
...
public class AccessibilityUtil {
    private static final String ACCESSIBILITY_SERVICE_PATH = AddContactsService.class.getCanonicalName();
    /**
     * 判断是否有辅助功能权限
     *
     * @param context
